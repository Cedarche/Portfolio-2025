...
import history_example from './CC_History.png'
import extension_example from './CC_Extension.png'
...
export const article = {
  ...
  date: '2025-03-24',
  title: 'Cross Copy - Simple cross platform media sharing',
  description:
    'At its core, Cross Copy provides a basic way to avoid having to email text and files to yourself. It works in a similar way to Google Drive or Dropbox, but without the bloat of folders, subscriptions, or size limits.',
}
...
At it's core, Cross Copy provides a simple way to avoid having
to email links, text, and files to yourself. It works in a similar way to
Google Drive or Dropbox, but without the bloat of folders,
subscriptions, or size limits.

<ArticleImage src={hero} alt="The Cross Copy landing page." />
...
<ul className="mt-6 space-y-6">
  ...
  <li className="flex items-center gap-4">
    <span>
      <strong className="font-semibold">The Mobile Application</strong> - Allows
      you to share photos and files natively from your mobile device to Cross
      Copy.
    </span>
  </li>
  <li className="flex items-center gap-4">
...
<ArticleImage src={dashboard_example} alt="The Cross Copy homepage." />
...
The text section of the application supports instant sharing of rich-text
between devices. Any text that is typed or pasted into the window retains
it's content, styling, and media.

<div className="flex flex-col gap-y-4 sm:flex-row items-center justify-center gap-x-4">
  <ArticleImage
    src={text_example}
    alt="An example of the Cross Copy text section."
    className="h-[500px] w-auto rounded-sm"
  />
  <ArticleImage
    src={history_example}
    alt="An example of the Cross Copy history section."
    className="h-[500px] w-auto rounded-sm"
  />
</div>

Additionally, anything pasted will be stored in the History tab, so you'll
never lose another link again.
...
<code>react-native-document-scanner-plugin</code> to quickly generate PDF
...
<div className="flex flex-col items-center justify-center">
  <ArticleImage
    src={extension_example}
    alt="An example of the Cross Copy Extension"
    className="h-auto w-[300px] rounded-sm"
  />
</div>
...
You can visit the Cross Copy Extension in the webstore <a href="https://chromewebstore.google.com/detail/cross-copy/klbdmjmclllnpfedhjghiglcbmnianbo" target="_blank">here</a>.
