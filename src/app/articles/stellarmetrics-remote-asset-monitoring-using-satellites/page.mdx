...
export const article = {
  ...
  date: '2025-03-11',
  title: 'Stellarmetrics - remote asset monitoring using satellites',
  description:
    'A remote monitoring solution for assets in rural areas that utilizes the SWARM satellite network to send small packets of data (tank water levels, pressure readings, etc.). The system uses a central Hub with LoRa gateway capabilities to collect data from multiple distributed Nodes, significantly reducing costs compared to traditional satellite internet solutions.',
}
...
<ArticleImage src={Prototype1} alt="An early example" />
...
<ArticleImage src={HomepageExample} alt="The Stellarmetrics homepage." />
