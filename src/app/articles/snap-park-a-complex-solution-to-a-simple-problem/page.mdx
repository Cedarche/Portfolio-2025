...
<ArticleImage src={hero} alt="The Snap Park Landing page." />
...
<ArticleImage src={dashboard_example} alt="The Snap Park Dashboard." />
...
<ArticleImage src={billing_example} alt="An example of the Snap Park Billing page." />
