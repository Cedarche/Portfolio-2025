...
export const article = {
  ...
  date: '2025-03-11',
  title: 'Assetrix - Custom Asset tracking software',
  description:
...
worked fine, but hindsight is 20-20.
...
were placed in the same spot. Of course it isn't that simple, with
...
<div className="flex flex-col items-center justify-center gap-x-4 gap-y-4 sm:flex-row">
  <ArticleImage
    src={AssetrixQR1}
    alt="An example of a QR code sticker on a piece of equipment."
    className="h-[400px] w-auto rounded-2xl shadow-lg"
  />
  <ArticleImage
    src={AssetrixQR2}
    alt="A second example of a QR code sticker on a piece of equipment."
    className="h-[400px] w-auto rounded-2xl shadow-lg"
  />
</div>
...
organize equipment refurbishment. I haven't made either the code
