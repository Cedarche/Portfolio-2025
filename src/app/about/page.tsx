...
import portraitImage from '@/images/Headshot-nobg-small.png'
...
export const metadata: Metadata = {
  title: 'About',
  description:
    'I’m Tom Carruthers. Im a mechanical engineer/software developer living in London.',
}
      ...
      <div className="grid grid-cols-1 gap-y-16 lg:grid-cols-2 lg:grid-rows-[auto_1fr] lg:gap-y-12">
        ...
        <div className="lg:order-first lg:row-span-2">
          <h1 className="text-4xl font-bold tracking-tight text-zinc-800 sm:text-5xl dark:text-zinc-100">
            A mechanical engineer/software developer living in London.
          </h1>
          <div className="mt-6 space-y-7 text-base text-zinc-600 dark:text-zinc-400">
            ...
            <p>
              ...
              learning and building out various ideas and software projects.
              While I realize that most of my experience lends itself to more
