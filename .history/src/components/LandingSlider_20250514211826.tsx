        ...
        {tabs.map((tab) => (
          <button
            ...
            className={clsx(
              ...
              activeTab === tab.id
                ? 'flex-1 bg-blue-500 font-semibold text-zinc-100 hover:bg-blue-700 active:bg-zinc-800 active:text-zinc-100/70 dark:bg-blue-500/20 dark:hover:bg-zinc-600 dark:active:bg-blue-700 dark:active:text-zinc-100/70'
