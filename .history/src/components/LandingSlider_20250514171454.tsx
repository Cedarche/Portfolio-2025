  ...
  return (
    <div className="flex flex-col gap-6">
      {projects.map((project) => (
        <div
          key={project.name}
          className="group relative flex cursor-pointer items-start gap-4 rounded-lg border border-zinc-100 p-4 dark:border-zinc-700/60 hover:bg-zinc-50 dark:hover:bg-zinc-800/50 transition-all duration-200"
        >
