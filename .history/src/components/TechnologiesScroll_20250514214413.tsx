...
function TechnologyModal({ description }: { description: string }) {
  return (
    <motion.div
      ...
      className="absolute top-1/2 left-1/2 z-50 w-64 -translate-x-1/2 -translate-y-1/2 rounded-lg bg-white p-3 shadow-lg ring-1 ring-zinc-900/5 dark:bg-zinc-800 dark:ring-white/10"
    >
