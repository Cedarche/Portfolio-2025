...
import UQLogo from '@/images/UQLogo.png'
...
export const education = {
  ...
  location: 'Brisbane, QLD',
  description: 'Attended St John&apos;s College and played rugby union & tennis for the first two years of my university education. Received a High Distinction for my Honors thesis on the feasibility of using renewable technologies to power Ethereum mining.',
  logo: UQLogo,
}
