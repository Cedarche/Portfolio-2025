        ...
        {tabs.map((tab) => (
          <button
            ...
            className={clsx(
              ...
              activeTab === tab.id
                ? 'flex-1 bg-teal-500 font-semibold text-zinc-100 hover:bg-teal-700 active:bg-zinc-800 active:text-zinc-100/70 dark:bg-teal-500/30 dark:hover:bg-teal-500 dark:active:bg-teal-700 dark:active:text-zinc-100/70'
