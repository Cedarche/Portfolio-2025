...
export default function LandingSlider({ articles }: { articles: ArticleWithSlug[] }) {
  ...
  return (
    <div className="w-full">
      <div className="flex space-x-1 mb-8 p-1 border rounded-lg border-gray-500 overflow-none">
        {tabs.map((tab) => (
          <button
            key={tab.id}
            ...
            className={clsx(
              ...
              activeTab === tab.id
                ? 'bg-zinc-560 flex-1 text-white dark:bg-zinc-500 dark:text-zinc-200'
