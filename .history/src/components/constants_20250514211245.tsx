...
export const education = {
  ...
  location: 'Brisbane, QLD',
  description: 'Attended St Johns College and played rugby union & tennis for the first two years of my university education. Received first class honours in my final year.',
  logo: UQLogo,
}
