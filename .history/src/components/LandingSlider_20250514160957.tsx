...
export default function LandingSlider({ articles }: { articles: ArticleWithSlug[] }) {
  ...
  return (
    <div className="w-full">
      <div className="flex space-x-4 mb-8 border rounded-lg border-gray-500">
        {tabs.map((tab) => (
          <button
            key={tab.id}
            ...
            className={clsx(
              ...
              activeTab === tab.id
                ...
                : 'bg-zinc-400 text-zinc-800 hover:bg-zinc-700 dark:bg-zinc-800 dark:text-zinc-100 dark:hover:bg-zinc-700'
            )}
          >
            {tab.label}
          </button>
