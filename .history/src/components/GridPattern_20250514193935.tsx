    ...
    <svg ref={ref} aria-hidden="true" {...props}>
      ...
      <svg x="50%" y={yOffset} strokeWidth="0" className="overflow-visible">
        {staticBlocks.map((block) => (
          <Block 
            ...
            x={block[0]} 
            y={block[1]} 
            className="fill-neutral-100 stroke-neutral-950/5 dark:fill-green-600/40 dark:stroke-neutral-100/5"
          />
        ))}
      ...
      <defs>
        <pattern
          ...
          fill="none"
          className="stroke-neutral-950/5 dark:stroke-green-600/30"
        >
