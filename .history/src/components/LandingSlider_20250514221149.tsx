  ...
  return (
    <div className="flex flex-col gap-6">
      {projects.map((project) => (
        <div
          key={project.name}
          className="group relative flex cursor-pointer items-start gap-4 rounded-lg border border-zinc-100 p-4 dark:border-zinc-700/60 hover:bg-green-50 dark:hover:bg-zinc-800/50 transition-all duration-200"
        >
        ...
        {tabs.map((tab) => (
          <button
            ...
            className={clsx(
              ...
              activeTab === tab.id
                ? 'flex-1 bg-blue-500/20 font-semibold text-zinc-100 hover:bg-blue-700 active:bg-zinc-800 active:text-zinc-100/70 dark:bg-blue-500/30 dark:hover:bg-blue-500/80 dark:active:bg-blue-700 dark:active:text-zinc-100/70'
