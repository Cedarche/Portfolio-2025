...
function Block({
  ...
  return (
    <motion.path
      transform={`translate(${-32 * y + 196 * x} ${160 * y})`}
      ...
      <svg x="50%" y={yOffset} strokeWidth="0" className="overflow-visible">
        {staticBlocks.map((block) => (
          <Block 
            ...
            x={block[0]} 
            y={block[1]} 
            className="fill-neutral-100 stroke-neutral-950/5 dark:fill-neutral-800 dark:stroke-neutral-100/5"
          />
        ))}
        {hoveredBlocks.map((block) => (
          <Block
            ...
            className="fill-neutral-200 stroke-neutral-950/10 dark:fill-neutral-700 dark:stroke-neutral-600/10"
          />
        ))}
      </svg>
      <defs>
        <pattern
          ...
          fill="none"
          className="stroke-neutral-950/5 dark:stroke-neutral-100/5"
        >
