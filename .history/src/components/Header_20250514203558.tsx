...
function AvatarContainer({
  ...
  return (
    <div
      className={clsx(
        className,
        'h-12 w-12 rounded-full   bg-white/90 p-0.5 shadow-lg ring-1 shadow-zinc-800/5 ring-zinc-900/5 backdrop-blur-sm dark:bg-zinc-800/90 dark:ring-white/10 flex items-center justify-center',
      )}
      {...props}
    />
  )
