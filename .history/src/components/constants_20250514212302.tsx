...
export const education = {
  ...
  location: 'Brisbane, QLD',
  description: 'Attended St Johns College and played rugby union & tennis for the first two years of my university education. Received first class honours for my thesis on using renewable technologies to power a remote community to power cryptocurrency mining.',
  logo: UQLogo,
}
