...
function AvatarContainer({
  ...
  return (
    <div
      className={clsx(
        className,
        'mb-1 flex h-12 w-12 items-center justify-center rounded-full bg-white/90 p-0.5 shadow-lg ring-1 shadow-zinc-800/5 ring-zinc-900/5 backdrop-blur-sm dark:bg-zinc-800/90 dark:ring-white/10',
      )}
      {...props}
    />
  )
...
export function Header() {
  ...
  useEffect(() => {
    ...
    function updateAvatarStyles() {
      ...
      // Original size: h-80 (320px) min-w-62 (248px)
      // Final size: h-9 (36px) w-9 (36px)
      let fromScale = 1
      let toScale = 36 / 320 // 9/80 = 0.1125 (ratio of final height to initial height)
      let fromX = 0
      let toX = 2 / 16
            ...
            >
              ...
              >
                <div className="relative">
                  ...
                  <Avatar
                    large
                    className="mt-24 block h-16 w-16 origin-left"
