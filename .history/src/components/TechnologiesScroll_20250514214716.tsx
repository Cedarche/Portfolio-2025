...
function TechnologyModal({ description }: { description: string }) {
  ...
  return (
    <motion.div
      ...
      className="fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-64 p-3 bg-white dark:bg-zinc-800 rounded-lg shadow-lg ring-1 ring-zinc-900/5 dark:ring-white/10 z-[100]"
    >
