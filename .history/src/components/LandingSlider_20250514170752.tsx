  ...
  return (
    <div className="flex flex-col gap-8">
      {projects.map((project) => (
        ...
        >
          <div className="absolute -inset-x-2 -inset-y-2 z-0 scale-95 bg-zinc-50 opacity-0 transition group-hover:scale-100 group-hover:opacity-100 sm:-inset-x-6 sm:rounded-2xl dark:bg-zinc-800/50" />
