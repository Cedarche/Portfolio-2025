    ...
    <>
      <Container className="mt-9">
        <div className="flex flex-col gap-8 lg:flex-row">
          <div className="w-full lg:w-1/4 aspect-square lg:mr-2">
            <Image
              src={avatarImage}
              alt="Tom Carruthers"
              className="md:hidden h-full w-full rounded-2xl object-cover"
              priority
            />
          </div>
          <div className="w-full lg:w-3/4">
            ...
            <p className="mt-6 text-base text-zinc-600 dark:text-zinc-400">
              ...
              applications and internal tools. I&apos;m a mechanical engineer and a self-taught developer with 5+
              years of experience designing, developing, and managing fullstack
            ...
            <TechnologiesScroll />
            <div className="mt-6 flex items-center justify-end md:justify-start gap-6">
              <SocialLink
                href="#"
