      ...
      <Container className="mt-9">
        <div className="max-w-2xl">
          ...
          <p className="mt-6 text-base text-zinc-600 dark:text-zinc-400">
            ...
            anything and everything - from software to hardware. I&apos;ve built
            a number of both personal and commercial projects over the years,
            and I&apos;m currently looking for work in London, UK as a
            front-end/fullstack software engineer.
          </p>
          <div className="mt-6 flex gap-6 flex-row">
            <SocialLink
              href="#"
