        ...
        {projects.map((project) => (
          <Card as="li" key={project.name}>
            ...
            <div className="mt-6 flex flex-col gap-4">
              ...
              <Link href={`/articles/${project.link.article}`} className="relative z-10 flex items-center text-sm font-medium text-zinc-400 transition group-hover:text-teal-500 dark:text-zinc-200">
