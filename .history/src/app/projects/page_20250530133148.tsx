      ...
      >
        {projects.map((project) => (
          <Card as="li" key={project.name}>
            ...
            <p className="relative z-10 mt-6 border flex items-center justify-center text-sm font-medium text-zinc-400 transition group-hover:text-teal-500 dark:text-zinc-200 ">
              <ArticleIcon className="ml-0.5 h-5.5 w-5.5 flex-none" />
              <Card.Cta className="mt-0 border">Read article</Card.Cta>
            </p>
          </Card>
        ))}
      </ul>
