    ...
    <>
      <Container className="mt-28 ">
        <div className="flex flex-col gap-8 lg:flex-row">
          <div className="aspect-square w-full lg:mr-2 lg:w-1/4 border rounded-2xl bg-zinc-100 dark:bg-zinc-800 border-zinc-200 dark:border-zinc-700/60">
            <Image
              src={avatarImage}
              alt="Tom Carruthers"
      ...
      <div className="fixed inset-x-0 top-0 z-50 h-[884px] overflow-hidden rounded-t-4xl bg-gradient-to-b from-neutral-50 to-transparent dark:from-neutral-800/50 dark:to-transparent">
        <GridPattern
