...
What started as a simple experiment with QR codes quickly developed into 4-6 month obsession where I spent every moment outside work hours developing a fully functional SaaS product.
