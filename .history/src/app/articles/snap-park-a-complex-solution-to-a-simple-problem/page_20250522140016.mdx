...
employee as a webapp, but with a more streamlined UI/UX, and native app notifications rather than text messages.
...
>
  <source src="/Snappark_App_Example.mov" type="video/quicktime" />
