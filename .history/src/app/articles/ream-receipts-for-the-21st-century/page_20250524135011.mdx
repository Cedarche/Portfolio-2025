...
<Image src={tile_cutaway_dark} alt="An example of the tile and a digital receipt." />
<Image src={tile_prototype} alt="An example of the tile and a digital receipt." />
<Image src={tile_dark} alt="An example of the tile and a digital receipt." />
