...
<Image src={Assetrix_1} alt="An example of the tile and a digital receipt." />
<Image src={Assetrix_2} alt="An example of the tile and a digital receipt." />
...
<Image src={AssetrixQR1} alt="An example of the tile and a digital receipt." />
<Image src={AssetrixQR2} alt="An example of the tile and a digital receipt." />
