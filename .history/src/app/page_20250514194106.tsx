  ...
  return (
    <>
      ...
      <div className="absolute inset-x-0 top-0 -z-10 h-[884px] overflow-hidden rounded-t-4xl bg-gradient-to-b from-neutral-50 to-transparent dark:from-neutral-800/50 dark:to-transparent">
        <GridPattern
          className="absolute inset-0 h-full w-full [mask-image:linear-gradient(to_bottom_left,white_40%,transparent_50%)] dark:[mask-image:linear-gradient(to_bottom_left,black_20%,transparent_50%)] fill-neutral-100 stroke-neutral-950/5 dark:fill-neutral-700/50 dark:stroke-neutral-100/5"
          yOffset={-270}
        />
      </div>
    </>
