...
function Education() {
  return (
    <div className="rounded-2xl border border-zinc-100 p-6 dark:border-zinc-700/60 bg-zinc-50 dark:bg-zinc-900/10">
    ...
    <>
      ...
      <Container className="mt-10 md:mt-28">
        <div className="flex flex-col gap-8 lg:flex-row">
          <div className="aspect-square w-full rounded-2xl border border-zinc-200  lg:mr-2 lg:w-1/4 dark:border-zinc-700/60 bg-zinc-100 dark:bg-zinc-800">
            <Image
              src={avatarImage}
              alt="Tom Carruthers"
