    ...
    <>
      ...
      <Container className="mt-10 md:mt-28">
        <div className="flex flex-col gap-8 lg:flex-row">
          <div className="aspect-square w-full rounded-2xl border shadow-2xl border-zinc-200  lg:mr-2 lg:w-1/4 dark:border-zinc-700/60 bg-zinc-100 dark:bg-zinc-800">
            <Image
              src={avatarImage}
              alt="Tom Carruthers"
