...
import { ChevronDownIcon, PaperAirplaneIcon } from '@heroicons/react/16/solid'
      ...
      >
        <Fieldset className="mt-10 w-full sm:w-xl">
          <FieldGroup>
            ...
            <Button href="#" variant="submit" className="group">
              Send
              <PaperAirplaneIcon className="h-4 w-4 stroke-zinc-400 transition group-active:stroke-zinc-600 dark:group-hover:stroke-zinc-50 dark:group-active:stroke-zinc-50" />
            </Button>
          </FieldGroup>
        </Fieldset>
        {/* ... */}
